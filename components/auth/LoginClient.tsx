          ...
          {otpStep === "code" ? (
            <form onSubmit={handleVerifyOtp} className="space-y-5">
              <p className="text-sm text-[#64748B]">
                הזן את הקוד שנשלח ל־<span dir="ltr" className="font-medium text-[#0F172A]">{phone}</span>
              </p>
              <div>
                <label htmlFor="otp" className="block text-sm font-medium text-[#0F172A] mb-2">
                  קוד אימות
                </label>
                <input
                  type="text"
                  ...
                  className="w-full rounded-lg border border-[#E2E8F0] px-4 py-3 text-center text-2xl tracking-[0.35em] font-mono focus:outline-none focus:border-[#1E6F7C] focus:ring-[3px] focus:ring-[rgba(30,111,124,0.15)]"
                  placeholder="●●●●●●"
                  dir="ltr"
                />
              </div>
              ...
              >
                {loading ? (isTenantLogin ? "מאמת..." : "מתחבר...") : isTenantLogin ? "אמת והמשך" : "התחברות"}
              </button>
              <button
                type="button"
                disabled={loading}
                ...
                className="w-full text-sm font-medium text-[#1E6F7C] hover:text-[#155969]"
              >
                שנה מספר טלפון
              </button>
            </form>
            ...
            <>
              ...
              <div className="relative my-6">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-white text-[#64748B]">או עם מספר טלפון</span>
                </div>
              </div>
              ...
              <form onSubmit={handleSendOtp} className="space-y-5">
                ...
                <button
                  ...
                  className="w-full px-6 py-3 bg-[#0F172A] hover:bg-[#1E293B] text-white rounded-lg font-semibold transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {loading ? (isTenantLogin ? "שולח..." : "שולח קוד...") : isTenantLogin ? "שלח קוד והמשך" : "שלח קוד אימות"}
                </button>
              </form>
            </>
          )}
