                ...
                <tr key={task.id} className={`border-b border-slate-100 ${rowClass}`}>
                  ...
                  <td className="py-1 px-2 align-middle min-w-0">
                    <input
                      ...
                      placeholder="כותרת..."
                      className="w-full min-w-0 bg-transparent border-0 border-b border-transparent hover:border-slate-300 focus:border-caleno-deep focus:outline-none py-0.5 text-right text-inherit placeholder-slate-400"
                      dir="rtl"
                    />
                  </td>
                </tr>
