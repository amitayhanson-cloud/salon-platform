      ...
      <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 flex justify-center">
          <a
            ...
            className="inline-flex w-full items-center justify-center rounded-xl border border-gray-300 bg-white px-6 py-3 text-base font-medium leading-normal text-caleno-ink hover:bg-caleno-off sm:w-auto"
          >
