...
/** Sun→א … Sat→ש — for cramped mobile week chart ticks */
const EN_SHORT_TO_SINGLE_LETTER: Record<string, string> = {
  Sun: "א",
  Mon: "ב",
  Tue: "ג",
  Wed: "ד",
...
/**
 * Single Hebrew weekday letter for an Israel-calendar YYYY-MM-DD (א–ש, Sun–Sat).
 */
export function hebrewWeekdayLetterIsraelYmd(ymd: string, tz = "Asia/Jerusalem"): string {
  ...
  return EN_SHORT_TO_SINGLE_LETTER[enShort] ?? "·";
}
