...
export const hair1EditorSchema: EditableTarget[] = [
  ...
  // Header (granular)
  {
    ...
    selectorId: "header",
    type: "section",
    editablePaths: ["themeColors.primary", "themeColors.primaryText", "sectionStyles.header.pillStyle"],
  },
  {
    id: "headerBg",
    label: "רקע כותרת",
    selectorId: "headerBg",
    type: "color",
    editablePaths: ["themeColors.primary", "themeColors.surface", "sectionStyles.header.pillStyle"],
  },
  {
    id: "headerText",
    ...
    type: "text",
    editablePaths: ["content.header.brandName", "branding.logoUrl", "themeColors.primaryText", "themeColors.text", "sectionStyles.header.pillStyle"],
  },
  {
    id: "headerNavLink",
    label: "קישורי ניווט",
