...
export default function SignupPage() {
  ...
  return (
    <div dir="rtl" className="relative min-h-screen w-full overflow-x-hidden">
      {/* Match tenant admin: soft Caleno teal radial wash */}
      <div
        aria-hidden
      ...
      />
      {/* Subtle corner accent (brand mint / deep) */}
      <div
        aria-hidden
      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-md flex-col justify-center px-4 py-10 sm:py-14">
        <div className="relative overflow-hidden rounded-2xl border border-caleno-deep/20 bg-white/90 shadow-[0_8px_40px_-8px_rgba(30,111,124,0.22)] backdrop-blur-sm sm:p-8 p-6 text-right">
          ...
          <div className="mb-5 pt-1">
            {/* LTR wrapper so logo sits visually top-left like landing header */}
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label htmlFor="email" className="block text-sm font-medium text-caleno-ink mb-2">
                אימייל
              </label>
              <input
                type="email"
            ...
            <div>
              <label htmlFor="password" className="block text-sm font-medium text-caleno-ink mb-2">
                סיסמה
              </label>
              <input
                type="password"
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-medium text-caleno-ink mb-2">
                אימות סיסמה
              </label>
              <input
                type="password"
            ...
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 rounded-lg border border-caleno-deep/30 bg-white/90 px-4 py-3 font-medium text-caleno-ink shadow-sm hover:border-caleno-deep/45 hover:bg-caleno-50/80 transition disabled:opacity-50"
            >
