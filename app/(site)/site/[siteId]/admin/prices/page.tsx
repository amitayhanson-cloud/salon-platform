...
export default function PricesPage() {
  ...
  // Tab state for prices page
  type PricesTabType = "services" | "pricing";
  const [activeTab, setActiveTab] = useState<PricesTabType>("services");
  ...
  const handleDeleteService = async (serviceId: string) => {
    ...
    try {
      ...
      // Delete service
      await deleteService(siteId, serviceId);
    } catch (err) {
  ...
  return (
    <div dir="rtl" className="min-h-screen bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 py-6">
        <div className="mb-6">
          <div>
            <h1 className="text-2xl font-bold text-slate-900">מחירון ושירותים</h1>
